...
jsPsych.plugins["choice-array"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    console.log('choice-array, trial', trial) 
    image_1 = trial.stimulus[0]
    image_2 = trial.stimulus[1]
    image_3 = trial.stimulus[2]


    var new_html = trial.prompt
    new_html += '<br><div>' + 
      '<div>' + // style="text-align:center;  display: flex" >' + 
        '<img style="flex: 1"  src="'+image_1+'" id="choice-array-stimulus"></img>'+
        '<img style="flex: 2" src="'+image_2+'" id="choice-array-stimulus"></img>'+
      '</div>' + 
      '<div style="text-align:center" >' +
        '<img style="" src="'+image_3+'" id="choice-array-stimulus"></img>'+
      '</div>'+ 
      '</div>'
