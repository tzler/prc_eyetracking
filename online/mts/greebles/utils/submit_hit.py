...
n_hours_to_complete_hit = .50
n_hours_to_accept_hit = .50
...
def determine_bonus_and_time(params): 
    ...
    n_trials  = 64 # ( 108 - params['n_practice_stimuli'] ) 
    max_bonus = 2 # n_trials * params['trial_bonus']
    max_time = 4# np.ceil(  (n_trials * 5)  /60)
